  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-agua/30 bg-agua/5 p-4 text-sm text-slate-700">
        💧 <strong>Olá!</strong> Aqui você vê os equipamentos do laboratório com o status de calibração de cada um. É só pra consulta — assim você acompanha que os instrumentos estão sempre em dia.
      </div>
