...
export default async function PortalAPPCCPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-agua/30 bg-agua/5 p-4 text-sm text-slate-700">
        💧 <strong>Olá!</strong> Aqui você consulta os Pontos Críticos de Controle (PCCs), seus
        limites críticos e a última leitura de monitoramento de cada um. Tela de consulta.
      </div>
            ...
            return (
              ...
              >
                <header className="flex items-center justify-between mb-3">
                  <div>
                    <span className="font-mono text-sm font-semibold text-petroleo">{pcc.numero}</span>
