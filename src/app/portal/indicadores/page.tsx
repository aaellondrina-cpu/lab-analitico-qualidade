...
export default async function PortalIndicadoresPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-agua/30 bg-agua/5 p-4 text-sm text-slate-700">
        💧 <strong>Olá!</strong> Aqui você acompanha os principais indicadores da qualidade —
        aprovação de lotes, conformidade analítica, NCs e tendências. Tela de consulta.
      </div>
