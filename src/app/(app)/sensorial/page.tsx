...
export default async function SensorialPage() {
  await requireUser();
  ...
  return (
    <>
      <PageHeader
        ...
        action={
          <Link href="/sensorial/nova" className="rounded-md bg-petroleo px-4 py-2 text-sm font-medium text-white hover:bg-petroleo-dark">
            + Nova avaliação
          </Link>
        }
      />
