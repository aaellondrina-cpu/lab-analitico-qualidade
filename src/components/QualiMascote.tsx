...
// Portal do Cliente — mesmos 15 capítulos do lab, mas adaptados pro ponto de
// vista de quem CONSUMA o sistema (visualiza/acompanha) em vez de quem opera.
const STEPS_PORTAL: Step[] = [
  {
    ...
    m2: "2026",
    m3: "ATIVO",
    text: "Olá! Sou o Quali, mascote do LimsQual! Vou te mostrar todo o controle de qualidade da sua produção de bebidas — do recebimento de insumos até o laudo final que você pode baixar em PDF.",
    info: "Portal do Cliente — sua área completa pra acompanhar produção, análises, laudos e indicadores conforme ISO 17025, ISO 22000 e FSSC 22000.",
  },
  {
    ch: "Dashboard",
    badge: "DASHBOARD",
    ...
    m2: "3 NC",
    m3: "2 ALRT",
    text: "Sua primeira tela é o Dashboard. Em tempo real você vê: lotes em produção, ordens de serviço em análise, laudos disponíveis, não conformidades abertas, insumos em quarentena e calibrações vencendo.",
    info: "Menu lateral → Dashboard. Cards: Lotes em produção • OS em análise • Laudos disponíveis • NCs abertas • Insumos em quarentena • Calibrações vencendo.",
  },
  {
    ch: "Produtos",
    badge: "PRODUTOS",
    ...
    m2: "Brix 11",
    m3: "CO2 3.5",
    text: "Aqui você acompanha os produtos da sua empresa: nome, código, sabor, volume, tipo de embalagem PET vidro ou lata e versão regular diet ou zero. Vê também as especificações técnicas com valor mínimo e máximo de cada parâmetro analítico.",
    info: "Menu → Produtos. Especificações: pH • Brix • Densidade • CO₂ • Acidez titulável • Turbidez • Coliformes • Bolores e leveduras.",
  },
  {
    ch: "Insumos",
    badge: "INSUMOS",
    ...
    m2: "CO2 99%",
    m3: "APROV",
    text: "Acompanhe todos os insumos da sua produção: água de processo, açúcar, dióxido de carbono grau alimentício, concentrados, edulcorantes, acidulantes, conservantes e corantes. Pra cada lote você vê número, validade e o certificado de análise do fornecedor.",
    info: "Menu → Insumos. Status: Em análise → Aprovado ou Reprovado ou Quarentena. Rastreabilidade bidirecional do insumo até o lote final.",
  },
  {
    ch: "Embalagens",
    badge: "EMBALAGEM",
    ...
    m2: "TORQ OK",
    m3: "APROV",
    text: "As embalagens têm controle próprio. Pra garrafas PET você vê peso, espessura de parede, resistência à pressão e torque da tampa. Pra vidro retornável vê o número de trips e o resultado microbiológico pós-lavagem.",
    info: "Menu → Embalagens. Tipos: PET • Vidro retornável • Vidro não retornável • Lata • Tampa • Rótulo. Cada lote analisado antes de liberar pra linha.",
  },
  {
    ch: "Lotes",
    badge: "LOTE 34A",
    ...
    m2: "TURNO M",
    m3: "1200 CX",
    text: "O módulo de lotes é o coração do sistema! Cada lote da sua produção tem número automático, data e hora de início, produto fabricado, volume produzido, linha de produção e turno. Você consegue ver quais insumos e embalagens foram usados — rastreabilidade completa de ponta a ponta.",
    info: "Menu → Lotes. Status: Em produção → Aguardando análise → Aprovado / Reprovado / Reprocesso → Expedido.",
  },
  {
    ch: "Ordens de serviço",
    badge: "OS-0042",
    ...
    m2: "pH 3.4",
    m3: "PEND",
    text: "Pra cada análise o sistema gera uma Ordem de Serviço numerada. Você acompanha o tipo: matéria prima, xarope simples, xarope composto, produto acabado, embalagem, água de processo, swab de superfície, CIP, retenção ou reclamação de cliente.",
    info: "Menu → Amostras / OS. Fluxo: Recebida → Em análise → Aguardando aprovação → Aprovado → Laudo emitido.",
  },
  {
    ch: "Resultados",
    badge: "CONFORME",
    ...
    m2: "Brix 10",
    m3: "OK",
    text: "Na tela da OS você vê cada resultado lançado pelo analista com valor obtido, unidade, método analítico e equipamento. O sistema compara automaticamente com a especificação e indica conforme em verde, atenção em amarelo, ou não conforme em vermelho.",
    info: "Conformidade automática: Conforme ✅ • Atenção ±10% ⚠️ • Não conforme ❌. Resultado fora do limite abre NC automaticamente.",
  },
  {
    ch: "Não conformidades",
    ...
    m2: "NC-007",
    m3: "RETER",
    text: "Quando um resultado sai fora do limite o sistema abre uma não conformidade automaticamente. Você acompanha a disposição: liberar com justificativa, reter o lote, reprocessar ou descartar. E vê a causa raiz e a ação corretiva com prazo.",
    info: "Menu → Não conformidades. Disposição: Liberar • Reter lote • Reprocessar • Descarte. Causa raiz: 5 Porquês ou Ishikawa.",
  },
  {
    ch: "Laudos",
    ...
    m3: "INMETRO",
    text: "Com os resultados aprovados o sistema gera o laudo em PDF automaticamente. O cabeçalho traz logo, CNPJ, nome e registro do Responsável Técnico, autorização do MAPA, registro da ANVISA e certificado de acreditação do INMETRO ISO 17025. Com QR Code de autenticidade.",
    info: "Menu → Laudos → selecione a OS → Baixar PDF. Cabeçalho com todos os registros oficiais. QR Code pra verificação pública por qualquer pessoa.",
  },
  {
    ch: "Equipamentos",
    badge: "CALIBRADO",
    ...
    m2: "REFRAT",
    m3: "VALID",
    text: "Você acompanha todos os equipamentos usados nas suas análises: pHmetro, refratômetro, densímetro, carbonatômetro, balança analítica, espectrofotômetro, turbidímetro, autoclave e estufa. Equipamento com calibração vencida fica bloqueado automaticamente — garantia da confiabilidade dos resultados.",
    info: "Status automático: Calibrado ✅ • Atenção vencendo em 30 dias ⚠️ • Vencido ❌. Bloqueio automático no lançamento de resultados.",
  },
  {
    ch: "CEP / SPC",
    ...
    m2: "CAPAZ",
    m3: "CTRL",
    text: "O Controle Estatístico de Processo gera automaticamente cartas de controle pra pH, Brix e CO₂ dos seus produtos. Calcula os índices Cp e Cpk. Acima de 1 vírgula 33 o processo está sob controle. Detecta tendências antes de virar não conformidade.",
    info: "Menu → CEP/SPC. Cartas X-barra e R com limites calculados automaticamente. Alertas pelas Regras de Nelson.",
  },
  {
    ch: "APPCC",
    badge: "PCC-02",
    ...
    m2: "72°C OK",
    m3: "CTRL",
    text: "O módulo APPCC controla os Pontos Críticos de Controle com os limites críticos. As leituras são lançadas por turno. Se uma leitura ultrapassar o limite crítico o sistema abre uma não conformidade automaticamente. Exigência da ISO 22000 pra segurança de alimentos.",
    info: "Menu → APPCC / HACCP. Campos: etapa, tipo de perigo, limite crítico mín/máx, frequência, responsável, ação corretiva.",
  },
  {
    ch: "Indicadores",
    badge: "KPIs",
    ...
    m2: "MTTR",
    m3: "TREND",
    text: "Na tela de Indicadores da Qualidade você acompanha os KPIs da sua produção: percentual de aprovação por produto e por mês, tempo médio de resolução de não conformidades, índice de retrabalho e tendências históricas. Tudo conforme ISO 17025 cláusula 8 ponto 9.",
    info: "Menu → Relatórios → Indicadores da Qualidade. Gráficos de tendência, comparativos mensais, ranking de NCs por causa raiz.",
  },
  {
    ch: "Configurações",
    badge: "CONFIG",
    ...
    m2: "MAPA OK",
    m3: "INMET",
    text: "Em configurações ficam os dados do seu laboratório que aparecem em todos os laudos: logo, razão social, CNPJ, Responsável Técnico com registro profissional e assinatura digital, autorização do MAPA, registro da ANVISA, certificado INMETRO e licença da Vigilância Sanitária. Mantém todos os documentos sempre em dia.",
    info: "Menu → Configurações. Logo, CNPJ, RT, assinatura digital, MAPA, ANVISA, INMETRO CRL, Vigilância Sanitária.",
  },
];
